...
| labelAngle    | 'vertical' \| 'horizontal' \| 'diagonal' | Applicable for the following chart types only: All Column charts, 100% Stacked Area, Discrete Area, Discrete Line, Grouped Combo, Stacked Combo, Heatmap.                                                                                                                                                                                                     |
...
| labelSize                       | number \| false                                                                                                                                                                                                                                                         | Applicable to all chart types except for Number, Gauge, Word Cloud and Table. The number range should be between 50 and 200. Use `false` to unset the custom labelSize that was set from the chart builder (if any) - this is equivalent to setting the `labelSize` to 100.                                                                                                                                                                                                                |
...
| colorPalette                    | object \| false                                                                                                                                                                                                                                                         | Applicable for most chart types depending on the color palette type - discrete or continuous. Use `false` to unset the custom colorPalette that was set from the chart builder (if any).                                                                                                                                                                                                                                                                                                   |
...
|textColor|string (rgb colors, hex colors, word colors), 'auto' (no color)|
