...
#include "examples/.markdown/docs/chart/preparing-realm-app.md"
...
#include "examples/.markdown/docs/chart/preparing-chart-for-embedding/create-authentication-provider-realm.md"
